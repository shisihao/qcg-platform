<template>
  <el-dialog :title="form.id ? $t('table.edit') : $t('table.add')" :visible.sync="visible" @closed="onClose()">
    <el-form ref="form" :model="form" :rules="rules" label-width="120px">
      ...
      <el-form-item label="节点地址" prop="nft_url">
        <el-input v-model.trim="form.nft_url" placeholder="标识" clearable />
      </el-form-item>
      <el-form-item label="OSS地址" prop="oss_url">
        <el-input v-model.trim="form.oss_url" placeholder="标识" clearable />
      </el-form-item>
      <el-form-item label="开放接口地址" prop="open_url">
        <el-input v-model.trim="form.open_url" placeholder="标识" clearable />
      </el-form-item>
    </el-form>
...
<script>
import { addOrUpdate } from '@/api/platform'
